...
* January 2024—present: Applied Mathematics Research Assistant                                                                
  ...
  * Developed a novel low-rank, structure-preserving, highly accurate integrator for the Vlasov-Fokker-Planck equation in cylindrical coordinates. 
      * Paper submitted for review August 2026: J. Nakao, D.T. Jacobs*, and W. Taitano, ["An adaptive and conservative low-rank IMEX solver for the hybrid ion Vlasov-Fokker-Planck and fluid electron system."](https://arxiv.org/pdf/2608.19603){: target="_blank"} __Submitted__.
